      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={team1 === null || team2 === null || venue === null}
        ...
        {/* Display the error message if teams are the same */}
        {errorMessage && (
        ...
        {prediction && (
          <div className="mt-6 p-4 bg-gray-50 rounded-md">
            ...
            <div className="space-y-2">
              <p>
                <strong>{getTeamName(team1)}:</strong> {prediction.teamA.score} runs, {prediction.teamA.wickets} wickets, 
                Run Rate: {prediction.teamA.run_rate}
              </p>
              <p>
                <strong>{getTeamName(team2)}:</strong> {prediction.teamB.score} runs, {prediction.teamB.wickets} wickets, 
                Run Rate: {prediction.teamB.run_rate}
              </p>
              <p>
                <strong>Match Result:</strong> {prediction.teamB.match_result}
              </p>
            </div>
          </div>
        )}
